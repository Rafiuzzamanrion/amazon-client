    ...
    <div>
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-side">
          ...
          ></label>
          <ul className="menu p-4 w-72 min-h-full bg-orange-300 text-black font-bold">
           ...
           <li>
            <Link className="hover:scale-110 hover:ease-in hover:duration-150"  to={"/products/mensSneakers"}><MdOutlineProductionQuantityLimits size={20} /> Shop Now</Link>
           </li>
           <li>
