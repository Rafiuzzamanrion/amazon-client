    ...
    <div>
        ...
        >
          {reviews.map((review) => (
            <SwiperSlide key={review._id}>
              <div className="m-10 flex flex-col items-center lg:mx-24 bg-base-100 shadow-xl p-8 py-16 rounded-xl">
      ...
      <div className="flex justify-center items-center my-12">
        <form onSubmit={handleAddReview} className="bg-base-100 shadow-xl p-8 border border-orange-300 rounded-md md:w-1/2">
         ...
         <input className="btn bg-orange-400 hover:border-orange-400 hover:bg-orange-400 hover:scale-110 hover:ease-in hover:duration-200" type="submit" value="Send Review" />
         </div>
        </form>
      </div>
    </div>
